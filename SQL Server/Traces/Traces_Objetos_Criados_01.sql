...
begin
	...
	if(object_id(N'tempdb..#tmpObjC') is not null)
		drop table #tmpObjC
	...
	create index ix_tmpObjC_1 on #tmpObjC(start_time)
	...
	select distinct * 
		...
		where [database_name] <> 'tempdb'
			and datediff(day, start_time, getdate()) <= 3
			and [object_name] is not null
			--and [host_name] = 'DETIC-PA473-5B' --PATRICIA
