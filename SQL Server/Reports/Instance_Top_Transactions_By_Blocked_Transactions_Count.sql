...
BEGIN TRY
	...
	INSERT INTO @TabTranLocks 
		...
		WHERE a.request_status = 'GRANT' 
			AND (b.request_status = 'WAIT' OR b.request_status = 'CONVERT') AND a.request_owner_type = 'TRANSACTION' AND b.request_owner_type = 'TRANSACTION'

	INSERT INTO @TabBlockedTran 
		SELECT TOP 20 ttl.l_blocking_tran_id, COUNT(DISTINCT ttl.l_blocked_tran_id)
